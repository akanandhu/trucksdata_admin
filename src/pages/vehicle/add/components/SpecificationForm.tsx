...
const SpecificationForm = ({control}:{control:any}) => {
  return (
    <Fragment>
            ...
            <Grid item xs={12} sm={6}>
                <TextFormField control={control} id='torque' type='number' label='Maximum Torque (N-m)' required size='medium' />
            </Grid>
            <Grid item xs={12} sm={6}>
                <TextFormField control={control} id='cylinders' type='number' label='No Of Cylinders, Displacement (cc)' required size='medium' />
            </Grid>
            <Grid item xs={12} sm={6}>
                <TextFormField control={control} id='emission_standard' type='number' label='Emission Standard' required size='medium' />
            </Grid>
            <Grid item xs={12} sm={6}>
            <SelectFormField
                label='Fuel Type'
