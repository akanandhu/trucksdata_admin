  ...
  return (
    <Fragment>
      <Grid item xs={12} sm={6}>
        <TextFormField control={control} type='number' id='vehicle_weight' label='Gross Vehicle Weight (Kg)'  size='medium' />
      </Grid>
      <Grid item xs={12} sm={6}>
        <TextFormField control={control} type='number' id='kerb_weight' label='Kerb Weight (Range) (Kg)'  size='medium' />
      </Grid>
      <Grid item xs={12} sm={6}>
        <SelectFormField
      ...
      <Grid item xs={12} sm={6}>
        <TextFormField control={control} type='number' id='ground_clearance' label='Ground Clearance (mm)'  size='medium' />
      </Grid>
      <Grid item xs={12} sm={6}>
        <TextFormField control={control} type='number' id='cargo_box_ref' label='Cargo Box Ref Dimensions (mm)'  size='medium' />
      </Grid>
      <Grid item xs={12} sm={6}>
        <TextFormField control={control} type='number' id='fuel_tank_capacity' label='Fuel Tank Capacity'  size='medium' />
      </Grid>
      <Grid item xs={12} sm={6}>
        <TextFormField control={control} type='number' id='fuel_tank_material' label='Fuel Tank Material'  size='medium' />
      </Grid>
      <Grid item xs={12} sm={6}>
